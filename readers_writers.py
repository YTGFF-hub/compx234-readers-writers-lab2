...
class ReadersWritersMonitor:
    ...
    def end_read(self, reader_id: int) -> None:
        ...
        with self.condition:
            ...
            # If this is the last reader, wake up all waiting threads
    ...
    def start_write(self, writer_id: int) -> None:
        ...
        with self.condition:
            ...
            # Wait until no readers or writers are using the resource
...
def main() -> None:
    ...
    print("All threads have finished. The simulation is complete")
